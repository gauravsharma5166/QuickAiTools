  ...
  return (
    ...
    justify-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
        <div className='text-center mb-6'>
            <h1 className='text-3x1 sm:text-5xl md:text-6x1 2xl:text-7x1
        ...
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            ...
            creating now</button>
            <button className='bg-white px-10 py-3 rounded-1g border
            border-gray-300 hover:scale-102 active: scale-95 transition
            cursor-pointer'>Watch demo</button>
        </div>

        <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
            <img src="assest.user_group" alt="" className='h-8' />Trusted by 10k+ users
        </div>
