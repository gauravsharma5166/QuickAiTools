  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        rounded-md border border-gray-300' placeholder='Describe waht you want to see in the image...' required/>
        ...
        text-sm rounded-lg cursor-pointer shadow-md hover:shadow-lg transition-shadow">
          {
